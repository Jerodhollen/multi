...
import NewAlterScreen from '../../screens/MainScreens/NewAlterScreen'
...
import ChangeCurrentAlterScreen from '../../screens/MainScreens/ChangeCurrentAlterScreen';
...
export default function ProfileStackScreen() {
  return (
    <ProfileStack.Navigator
      ...
      />
      <ProfileStack.Screen name="Search Alters" component={AddFriendScreen} />
      <ProfileStack.Screen name="ChangeCurrentAlter" component={ChangeCurrentAlterScreen} />
      <ProfileStack.Screen name="NewAlter" 
        component={NewAlterScreen}
        options={{
          headerTitleAlign: 'center',
        }}
      />
